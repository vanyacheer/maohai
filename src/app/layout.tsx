...
const defaultDescription = "毛孩呼吸提供犬貓居家氧氣照護、EverFlo 與 EverFlo Q 氧氣濃縮機租借，以及到府安裝與操作說明。";

export const metadata: Metadata = {
  metadataBase: new URL(siteUrl),
  title: { default: "毛孩呼吸｜犬貓居家氧氣機租借", template: "%s｜毛孩呼吸" },
  description: defaultDescription,
  keywords: ["寵物氧氣機", "犬貓氧氣機", "寵物氧氣機租借", "EverFlo", "EverFlo Q", "居家氧氣照護"],
