...
export default async function Home() {
  ...
  return <>
    <section className="hero warm-scene"><div className="container hero-grid"><div className="hero-copy"><span className="eyebrow">♡ 給牠最純淨的愛</span><h1>每一次呼吸<br />都是<span>愛</span>的延續</h1><p>提供犬貓居家氧氣治療、氧氣機租借與照護支援，陪伴心臟病、肺部疾病、術後恢復與高齡毛孩，在熟悉的家中獲得穩定安心的呼吸支持。</p><div className="button-row"><Link className="button primary" href="/products">探索產品</Link><Link className="button ghost" href="/rental">查看租借方案</Link></div><div className="hero-stats"><div><strong>2</strong><span>款專業機型</span></div><div><strong>93%</strong><span>氧氣濃度</span></div><div><strong>0.5–5</strong><span>L/min 流量</span></div></div></div><div className="hero-visual glass-panel">
    
      <Image className="hero-machine" src={heroProduct.image} alt={heroProduct.name} width={630} height={486} priority /><div className="oxygen-badge"><strong>93%</strong><span>穩定高濃度氧氣</span></div></div></div><div className="container feature-ribbon glass-panel"><div><b>93%</b><span><strong>穩定製氧</strong><small>氧氣濃度 93% ± 3%</small></span></div><div><b>40dB</b><span><strong>靜音選擇</strong><small>EverFlo Q 安靜運轉</small></span></div><div><b>24h</b><span><strong>連續供氧</strong><small>長時間居家照護</small></span></div><div><b>到府</b><span><strong>安裝教學</strong><small>定位、連接與基礎操作</small></span></div></div></section>
